...
\COPY questions FROM 'RELATIVE PATH' WITH DELIMITER ',' NULL 'null' CSV HEADER;
\COPY answers FROM 'RELATIVE PATH' WITH DELIMITER ',' NULL 'null' CSV HEADER;
\COPY photos FROM 'RELATIVE PATH' WITH DELIMITER ',' NULL 'null' CSV HEADER;
